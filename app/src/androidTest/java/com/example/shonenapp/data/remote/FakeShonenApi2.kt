...
class FakeShonenApi2 : ShonenApiService {
    ...
    private val characteres: Map<Int, List<ShonenCharacterResponse>> by lazy {
        mapOf(
            1 to page1,
            2 to page2,
            3 to page3,
    ...
    private fun calculatePage(page: Int): Map<String, Int?> {
        ...
        if (page1.isEmpty()) {
            return mapOf(PREV_PAGE to null, NEXT_PAGE to null)
        }
    ...
    override suspend fun getAllShonenCharacters(page: Int): ApiResponse {
        ...
        return ApiResponse(
            ...
            characters = characteres[page] ?: listOf()
        )
    }
